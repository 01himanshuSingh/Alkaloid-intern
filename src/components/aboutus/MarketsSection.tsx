    ...
    >
      <div className="max-w-screen-xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        >
          ...
          <motion.p
            variants={fadeUpVariants}
            className="font-['Libre_Baskerville',serif] text-white/90 text-[14px] md:text-[0.9rem] lg:text-[15px] 2xl:text-[19px] leading-relaxed max-w-md lg:max-w-lg 2xl:max-w-xl mx-auto"
          >
            {data.subtitle}
          </motion.p>
        </motion.header>
