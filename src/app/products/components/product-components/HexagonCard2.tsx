...
export default function HexagonCard2({ product }: HexagonCardProps) {
  ...
  <h3
    className="font-['Geologica'] text-[14px] md:text-base lg:text-[18px] 2xl:text-[28px] font-semibold uppercase tracking-widest text-[#374151] leading-snug max-w-[160px] sm:max-w-[180px] md:max-w-[200px] lg:max-w-[280px] 2xl:max-w-[220px] text-center group-hover:text-[#0B67B2] transition-colors">
    {product.name}
  </h3>
