...
import ProductsShell from "./updated-components/components/ProductsShell";

export const metadata: Metadata = {
  title: "Our Products | Alkaloids Private Limited",

  description:
    "Explore Alkaloids' portfolio of Active Pharmaceutical Ingredients (API), Herbal Extracts as API, Advanced Intermediaries, and Products Under Development.",
  ...
  openGraph: {
    ...
    description:
      "Explore Alkaloids pharmaceutical products including APIs, Herbal Extracts and Advanced Intermediaries.",

    url: "https://alkaloids.in/products",

    siteName: "Alkaloids Private Limited",
  ...
  twitter: {
    ...
    description:
      "Explore Alkaloids pharmaceutical products including APIs and Herbal Extracts.",
  },
...
export default function ProductsPage() {
  const { heroImage } = productPageData;
